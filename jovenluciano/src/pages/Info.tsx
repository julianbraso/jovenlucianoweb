      ...
      <div id="body" className="flex-grow">
        <div className={"w-[90%] [overflow-anchor:none] pt-3 pb-20 flex flex-grow items-center md:items-start justify-center flex-col md:flex-row h-fit gap-5 md:gap-10"}>
          ...
          <div className="text-[#00ff00] text-start h-fit w-[80%] md:w-[30%] flex flex-col">
            ...
            <p className="font-light text-lg">Hello! I’m Joven Luciano, a technical artist, painter, and creative director. With a passion for exploring the intersection of art and technology, I have dedicated my career to research and innovation. My work delves into how artistic expression can be enhanced and transformed through technological advancements, creating immersive and groundbreaking experiences.
